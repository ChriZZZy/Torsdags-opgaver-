public class Tax extends Field {
    ...
    protected String onReject(Player p) {
        ...
        float calcTax = currentassets * 10 / 100; // todo:  ændres til denne assignment: balance + assets * 0.1f; (Når der er kommet en værdi i 'assets')
    ...
    protected int calculateAssets(Player p) {
        int pvalues = p.getPorpertyValues()
        int assets = pvalues + p.getBalance();
